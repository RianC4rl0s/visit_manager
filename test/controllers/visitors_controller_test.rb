...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference("Visitor.count") do
      post visitors_url, params: { visitor: { cpf: @visitor.cpf, foto: @visitor.foto, name: @visitor.name, rg: @visitor.rg, telefone: @visitor.telefone } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { cpf: @visitor.cpf, foto: @visitor.foto, name: @visitor.name, rg: @visitor.rg, telefone: @visitor.telefone } }
